...
!..................................................................................................................................
   ...
   call ExtPtfmLd_InitVars(u, p, y, m, InitOut, .false., ErrStat2, ErrMsg2)
   if (Failed()) return
...
!----------------------------------------------------------------------------------------------------------------------------------   
subroutine ExtPtfmLd_InitVars(u, p, y, m, InitOut, Linearize, ErrStat, ErrMsg)
   type(ExtPtfmLd_InputType),          intent(inout)  :: u           !< An initial guess for the input; input mesh must be defined
   type(ExtPtfmLd_ParameterType),      intent(inout)  :: p           !< Parameters
   type(ExtPtfmLd_OutputType),         intent(inout)  :: y           !< Initial system outputs (outputs are not calculated;
   type(ExtPtfmLd_MiscVarType),        intent(inout)  :: m           !< Misc variables for optimization (not copied in glue code)
   type(ExtPtfmLd_InitOutputType),     intent(inout)  :: InitOut     !< Output for initialization routine
   logical,                        intent(in   )  :: Linearize   !< Flag to initialize linearization variables
   integer(IntKi),                 intent(  out)  :: ErrStat     !< Error status of the operation
   character(*),                   intent(  out)  :: ErrMsg      !< Error message if ErrStat /= ErrID_None

   character(*), parameter :: RoutineName = 'ExtPtfmLd_InitVars'
   ...
   call MV_AddMeshVar(InitOut%Vars%u, "PlatformMotion", MotionFields, DatLoc(ExtPtfmLd_u_PtfmMotion), Mesh=u%PtfmMotion) 
   ...
   call MV_AddMeshVar(InitOut%Vars%y, 'PlatformLoad', LoadFields, DatLoc(ExtPtfmLd_y_PtfmMesh), Mesh=y%PtfmMesh)
...
!..................................................................................................................................
   ...
   print *, "---- ConvertOpDataForOpenFAST ----"
