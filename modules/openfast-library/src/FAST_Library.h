...
EXTERNAL_ROUTINE void FAST_ExtPtfmLoads_Init(int * iTurb, double *TMax, const char *InputFileName, int * TurbineID, char *OutFileRoot, float * TurbinePosition, int *AbortErrLev, double * dtDriver, double * dt, int * NumBl, double * az_blend_mean, double * az_blend_delta, ExtPtfmLdDX_InputType_t* ExtPtfmLdDX_Input, ExtPtfmLdDX_ParameterType_t* ExtPtfmLdDX_Parameter, ExtPtfmLdDX_OutputType_t* ExtPtfmLdDX_Output, int *ErrStat, char *ErrMsg);
